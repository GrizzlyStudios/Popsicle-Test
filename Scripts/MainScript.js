...
function loadGame() {
    ...
    if (typeof savedGame.popsicleStand_amount !== "undefined") {
        popsicleStand_amount = savedGame.popsicleStand_amount
    }
    ...
    if (typeof savedGame.SeaGulls !== "undefined") {
        SeaGulls = savedGame.SeaGulls
    }
    if (typeof savedGame.PopsicleLevel !== "undefined") {
        PopsicleLevel = savedGame.PopsicleLevel
    }
    if (typeof savedGame.Suns !== "undefined") {
        Suns = savedGame.Suns
    }
    ...
    if (typeof savedGame.sun_amount !== "undefined") {
        sun_amount = savedGame.sun_amount
    }
    if (typeof savedGame.biggerWingsUpgradeCost !== "undefined") {
        biggerWingsUpgradeCost = savedGame.biggerWingsUpgradeCost
    }
    if (typeof savedGame.dog_amount !== "undefined") {
        dog_amount = savedGame.dog_amount
    }
